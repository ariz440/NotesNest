      ...
      <div className="w-full max-w-md bg-slate-800 rounded-3xl shadow-2xl shadow-black/30 p-6 sm:p-10">
        ...
        <form onSubmit={submitHandler} className="space-y-4 sm:space-y-5">
          ...
          <input
            ...
            className="w-full bg-slate-700 border border-slate-600 rounded-2xl p-3 sm:p-4 text-white placeholder-gray-400 outline-none focus:border-blue-500 duration-200"
            value={email}
          ...
          <button className="w-full bg-blue-600 hover:bg-blue-700 text-white py-3 sm:py-4 rounded-2xl font-semibold duration-300">
            Login
          </button>
